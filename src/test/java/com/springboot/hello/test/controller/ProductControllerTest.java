package com.springboot.hello.test.controller;

import com.google.gson.Gson;
import com.springboot.hello.controller.ProductContorller;
...
@WebMvcTest(ProductContorller.class)
public class ProductControllerTest {
    ...
    void createProductTest() throws Exception {
        //Mock 객체에서 특정 메서드가 실행되는 경우 실제 Return을 줄 수 없기 떄문에 아래와 같이 사정 사항을 만들어줌
